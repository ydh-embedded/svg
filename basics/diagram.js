...
carbohydrates.setAttribute("d", createArcPath(0, 100, 50, 55, 55))
carbohydrates.setAttribute("stroke", "magenta")
carbohydrates.setAttribute("stroke-width", "7")
carbohydrates.setAttribute("fill", "transparent")
fat.setAttribute("d", createArcPath(100, 250, 50, 55, 55))
fat.setAttribute("stroke", "red")
fat.setAttribute("stroke-width", "7")
fat.setAttribute("fill", "transparent")
proteins.setAttribute("d", createArcPath(250, 360, 50, 55, 55))
proteins.setAttribute("stroke", "green")
proteins.setAttribute("stroke-width", "7")
